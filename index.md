...
# Doing a Masters Degree at Kokkan (Prospective Students)
...
The centre of your applications will probably be your 'research proposal'; this section will give you some hints on how (and how *not*) to write this.
...
To give you a couple of examples from my field; media studies.

Another thing to take into account is; 'does this question have an answer, and is that answer interesting?'
...
* Are the things you are comparing actually comparable in a meaningful way?
...
> Compare users' discussion of topic X on Weibo in China and Twitter in the US and Japan.

### An example

For instance, this is a sentence taken from a proposal I received a few years ago:
...
Let's take this proposal apart and see how it should be improved, and what the problems are.
